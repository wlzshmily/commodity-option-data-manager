...
| REL-006 | In Progress | Codex | Run bounded live TQSDK collection windows and tune batch thresholds | `odm-collect --max-batches` live reports; WebUI batch-progress read model |
