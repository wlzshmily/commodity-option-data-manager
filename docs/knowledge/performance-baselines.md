...
- Runtime tuning: background refresh window default increased from 10 to 100 batches to reduce repeated TQSDK connect/discovery/subscription startup cost.
